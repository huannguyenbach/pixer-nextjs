      ...
      >
        <div className="min-h-screen text-center">
          <button
            ...
            className="fixed top-5 w-7 h-7 bg-light-100 rounded-full z-50 text-dark-900 outline-none transition-all hover:text-dark focus-visible:outline-none right-4 md:top-6 md:right-5 lg:top-7 lg:right-7"
          >
            <CloseIcon className="h-4 w-4 focus-visible:outline-none lg:h-[18px] lg:w-[18px] 3xl:h-5 3xl:w-5 mx-auto" />
          </button>
          <Transition.Child
            as={Fragment}
